  ...
  return (
    <div className='flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card'>
       ...
       <div className='flex flex-row'>
          <img src={img} alt="testimonial_images" className='w-[48px] h-[48px] rounded-full' />

          <div className='flex flex-col ml-4'>
            <h4 className={`font-poppins font-semibold text-[20px] text-white leading-[32px]`}>{name}</h4>
            <h4 className={`font-poppins font-normal text-[16px] text-dimWhite leading-[24px]`}>{title}</h4>
          </div>
       </div>
    </div>
  )
